...
public class ProjectModel implements org.drools.modelcompiler.CanonicalKieModuleModel {
    ...
    public java.util.List<Model> getModels() {
        return java.util.Arrays.asList(new org.acme.Rules5cb894750a3943ecb6fa8c6b7ffedbb8());
    }

    public java.util.List<Model> getModelsForKieBase(String kieBaseName) {
        switch (kieBaseName) {
            case "defaultKieBase": return java.util.Arrays.asList( new org.acme.Rules5cb894750a3943ecb6fa8c6b7ffedbb8() );
        }
